...
RB_LogisticsOptions_CDLC_UNA = [
    ...
    [
        ...
        [
            ...
            ["Suppressor Kit", ["muzzle_snds_M", "suppressor_l_camo_lxWS", "muzzle_snds_m_snd_F", "suppressor_l_lxWS", "suppressor_l_sand_lxWS", "suppressor_l_snake_lxWS", "muzzle_snds_B", "muzzle_snds_B_snd_F", "suppressor_h_lxWS", "suppressor_h_sand_lxWS", "muzzle_snds_12Gauge_lxWS", "suppressor_m_sand_lxWS", "suppressor_m_lxWS"], 75],
